  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-50">
      ...
      <div className="absolute left-1/2 -top-6 -translate-x-1/2 z-[60]">
        <button onClick={onAddClick} className="w-14 h-14 bg-gradient-to-tr from-purple-500 to-indigo-600 rounded-full flex items-center justify-center text-white shadow-lg shadow-purple-500/40 active:scale-90 transition-transform border-4 border-neutral-900">
      ...
      <div className="relative w-full h-32 flex items-center justify-center overflow-hidden py-4">
        {/* Navigation Arrows */}
        <button onClick={next} className="absolute left-4 z-20 p-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-white w-auto min-w-[40px] max-w-[40px] active:scale-90 transition-all">
          <ChevronLeft size={24} />
        </button>
        ...
        <button onClick={prev} className="absolute right-4 z-20 p-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-white w-auto min-w-[40px] max-w-[40px] active:scale-90 transition-all">
